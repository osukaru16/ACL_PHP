...
<div id="page">
    ...
    if ($_GET['action'] == 'role') { 
    	...
    	<h2>New Role:</h2>
        <?php } else { ?>
    	<h2>Manage Role: (<?php= $myACL->getRoleNameFromID($_GET['roleID']); ?>)</h2><?php } ?>
        <form action="roles.php" method="post">
        	<label for="roleName">Name:</label><input type="text" name="roleName" id="roleName" value="<?php= $myACL->getRoleNameFromID($_GET['roleID']); ?>" />
        ...
        <input type="hidden" name="roleID" value="<?php= $_GET['roleID']; ?>" />
