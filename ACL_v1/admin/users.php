...
<div id="page">
	...
	?>
    	<h2>Managing <?php= $myACL->getUsername($_GET['userID']); ?>:</h2>
     ...
     <h2>Manage User Roles: (<?php= $myACL->getUsername($_GET['userID']); ?>)</h2>
	...
	?>
    	<h2>Manage User Permissions: (<?php= $myACL->getUsername($_GET['userID']); ?>)</h2>
        <form action="users.php" method="post">
            <table border="0" cellpadding="5" cellspacing="0">
            <tr><th></th><th></th></tr>
            <?php 
